/*
Deployment script for FlexService.Glued.Database
...
GO
:setvar DatabaseName "FlexService.Glued.Database"
:setvar DefaultFilePrefix "FlexService.Glued.Database"
...
GO
PRINT N'Creating [dbo].[FK_OrderProduct_Order]...';


GO
ALTER TABLE [dbo].[OrderProduct]
    ADD CONSTRAINT [FK_OrderProduct_Order] FOREIGN KEY ([OrderId]) REFERENCES [dbo].[Order] ([Id]);


GO
PRINT N'Creating [dbo].[FK_OrderProduct_Product]...';


GO
ALTER TABLE [dbo].[OrderProduct]
    ADD CONSTRAINT [FK_OrderProduct_Product] FOREIGN KEY ([ProductId]) REFERENCES [dbo].[Product] ([Id]);
